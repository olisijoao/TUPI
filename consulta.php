        ...
        <div class="container">
            <div class="row">
                <div class="col offset-lg-8 mx-auto text-center">
                    <h1 class="text-white section-heading">CONSULTA DE CHAVES</h1>
                    <hr class="light my-4">    <p class="text-faded mb-4">Consulta as chaves cadastradas no Banco de Dados por status ou pelo serial do terminal aonde ela foi ativada. </p>
